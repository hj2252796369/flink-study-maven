 ...
 **/
public class FlinkTrans02ApplyWindowsApp {
    public static void main(String[] args) throws Exception {
        ...
        DataStream<VideoOrder> moneyDS = keyedStream.window(TumblingProcessingTimeWindows.of(Time.seconds(5)))
                        .apply(new WindowFunction<VideoOrder, VideoOrder, String, TimeWindow>() {
                            @Override
                            public void apply(String s, TimeWindow window, Iterable<VideoOrder> input, Collector<VideoOrder> out) throws Exception {
